...
### State Procurement
- **Live API search** for four states with confirmed working open-data access: New York (Socrata), Connecticut (Socrata), Texas (Socrata), and Virginia (CKAN, not Socrata, a different underlying platform)
...
- Track status per jurisdiction (not started to submitted to fulfilled)
...
| State open data APIs (Socrata for NY/CT/TX, CKAN for VA) | State procurement records |
