# Magnolia — JLR Domestic Violence Case

Interactive timeline and case map for the JLR domestic violence incident at the All Season River Inn in Leavenworth, WA — December 24–28, 2025.
...
Deputy K. Talley signed an affidavit for probable cause to arrest JLR for:

- **RCW 9A.36.021** — Assault in the 2nd Degree (DV)
- **RCW 9A.46.020.2B** — Harassment / Threats to Kill (DV)
- **RCW 9A.36.150** — Interfering with the Reporting of Domestic Violence

**JLR was not booked on any of the three charges.** Case turned over to Chelan County Prosecutors on December 30, 2025.

## Documented Injuries

- Bruising around right eye (early-stage black eye)
- Small red mark on upper right corner of bridge of nose
- Broken nose (confirmed in supplemental report; visibly crooked per deputy's training)
- Rib injuries (photographed by female medic in hotel bathroom)
...
| Deputy Lucas McComas (K31) | Responding officer |
| Deputy Randy Lake (K17) | Responding officer |
...
- `timeline.html` — Scrolling narrative timeline with Leaflet map
- `case-map.html` — Interactive map with togglable layers

## Tech Stack

- Leaflet.js v1.9.4
- CartoDB Dark Matter tiles
- Single self-contained HTML files — no server dependencies
